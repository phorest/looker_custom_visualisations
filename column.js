    ...
    if (typeof Chart !== 'undefined' && typeof ChartDataLabels !== 'undefined') {
      ...
      script.onload = () => {
        ...
        dlScript.onload = dlScript.onerror = () => {
          ...
          annScript.onload = annScript.onerror = _markLoaded; // render even if annotation fails
          ...
          chart.data.datasets.forEach((dataset, i) => {
            ...
            if (!meta.hidden && dataset.data[index] !== null && dataset.data[index] !== undefined) {
              ...
              if (val > 0) {
                ...
                if (barModel && barModel.y < topY) topY = barModel.y;
              }
            }
          });

          if (hasValue) ctx.fillText(safeFormat(total), x.getPixelForValue(index), topY - 5);
        });
        ctx.restore();
      }
    };
      ...
      options: {
        ...
        plugins: {
          title: {
            ...
            color: '#111',
            padding: { bottom: config.chart_title_padding || 50 }
          },
          legend: {
